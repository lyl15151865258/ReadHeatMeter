...
import cn.com.hfrjl.readheatmeter.interfaces.BaseFragmentInterface;
import cn.com.hfrjl.readheatmeter.interfaces.DialogControl;
...
public class BaseFragment extends Fragment implements View.OnClickListener, BaseFragmentInterface {
    ...
    public HfrjlApplication getApplication() {
        return (HfrjlApplication) getActivity().getApplication();
    }
